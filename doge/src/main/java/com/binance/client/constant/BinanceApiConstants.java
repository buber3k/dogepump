...
import com.dogepump.app.Config;
...
public class BinanceApiConstants {
     ...
     * REST API base URL.
     */
    public static final String API_BASE_URL = Config.BINANCE_CONFIGURATION().apiBaseUrl();

    /**
     * Streaming API base URL.
     */
    public static final String WS_API_BASE_URL = Config.BINANCE_CONFIGURATION().wsApiBaseUrl();
